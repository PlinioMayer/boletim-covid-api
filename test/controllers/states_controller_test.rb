...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { name: @state.name, population: @state.population, region: @state.region } }, as: :json
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { name: @state.name, population: @state.population, region: @state.region } }, as: :json
    assert_response 200
  end
